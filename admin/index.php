...
/* Obat terlaris */
$stmtTop = $pdo->query("SELECT o.nama_obat, SUM(d.jumlah) qty FROM detail_pesanan d JOIN obat o ON o.id_obat=d.id_obat GROUP BY d.id_obat ORDER BY qty DESC LIMIT 5");
...
/* Stok hampir habis */
$lowStock = $pdo->query("SELECT * FROM obat WHERE stok <= 20 ORDER BY stok ASC LIMIT 6")->fetchAll();
...
const top = new Chart(document.getElementById("topChart"), {
    type: "bar",
