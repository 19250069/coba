...
$("#modalForm").on("show.bs.modal", function(e){
    ...
    if (b.data("id")) { $("#fAct").val("edit"); $("#fId").val(b.data("id")); $("#fNama").val(b.data("nama")); $("#fAlamat").val(b.data("alamat")); $("#fHp").val(b.data("hp")); $("#fEmail").val(b.data("email")); $(this).find(".modal-title").text("Edit Supplier"); }
    else { $("#fAct").val("tambah"); $("#fId").val(""); $("#fNama").val(""); $("#fAlamat").val(""); $("#fHp").val(""); $("#fEmail").val(""); $(this).find(".modal-title").text("Tambah Supplier"); }
});
$("#modalDetail").on("show.bs.modal", function(e){
    var b = $(e.relatedTarget);
    $("#dNama").text(b.data("nama")); $("#dAlamat").text(b.data("alamat")); $("#dHp").text(b.data("hp")); $("#dEmail").text(b.data("email"));
});
</script>';
