...
<head>
    ...
    <title><?= e($page_title ?? 'Apotek Sehat') ?> | Apotek Sehat</title>
...
<body>
<nav class="navbar navbar-expand-lg sticky-top" style="background:var(--surface);border-bottom:1px solid var(--border);">
    <div class="container-fluid px-3">
        <a class="navbar-brand d-flex align-items-center gap-2 fw-bold" href="<?= BASE_URL ?>user/" style="color:var(--primary)">
            <img src="<?= BASE_URL ?>assets/images/logo.svg" width="32"> Apotek Sehat
        </a>
        ...
        <div class="collapse navbar-collapse" id="navuser">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <button id="darkToggle" title="Mode Gelap"><i class="fas fa-moon"></i></button>
                <div class="dropdown">
