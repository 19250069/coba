...
$stmt = $pdo->prepare("SELECT k.*, o.nama_obat, o.harga, o.gambar, o.stok FROM keranjang k JOIN obat o ON o.id_obat=k.id_obat WHERE k.id_user=? ORDER BY k.id_keranjang DESC");
$stmt->execute([$uid]);
$items = $stmt->fetchAll();
$total = 0;
